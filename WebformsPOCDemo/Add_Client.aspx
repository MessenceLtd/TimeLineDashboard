<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_Client.aspx.cs" Inherits="WebformsPOCDemo.Add_Client" culture="auto" meta:resourcekey="Page" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Company_Name" ClientIDMode="Static" CssClass="form-control long-input" 
                autocomplete="nope" meta:resourcekey="textbox_Company_Name"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Website_URL" ClientIDMode="Static" CssClass="form-control long-input" 
                 autocomplete="nope" meta:resourcekey="textbox_Website_URL"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_City" ClientIDMode="Static"
                CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_City"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Address" ClientIDMode="Static" CssClass="form-control long-input" 
                autocomplete="nope" meta:resourcekey="textbox_Address"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Address_Required" ErrorMessage="Please enter an address" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Address" CssClass="text-danger" meta:resourcekey="validator_Address_Required"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Zipcode.ClientID %>"><%= Resources.SiteCommon.Zip_Code %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Zipcode" ClientIDMode="Static" CssClass="form-control" 
                autocomplete="nope" meta:resourcekey="textbox_Zipcode"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Zipcode_Required" ErrorMessage="Please enter an zipcode" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Zipcode" CssClass="text-danger" meta:resourcekey="validator_Zipcode_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <asp:UpdatePanel runat="server" ClientIDMode="Static" ID="updatePanel_Default_Currency">
            <ContentTemplate>
                ...
                <div class="Form_Group">
                    ...
                    <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Vat_Percentage" ClientIDMode="Static" 
                        autocomplete="nope" CssClass="form-control" meta:resourcekey="textbox_Vat_Percentage"></asp:TextBox></div>
                </div>
            </ContentTemplate>
            <Triggers><asp:AsyncPostBackTrigger ControlID="dropdown_Country" /></Triggers>
        </asp:UpdatePanel>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Mobile_Phone" ClientIDMode="Static" CssClass="form-control" 
                autocomplete="nope" meta:resourcekey="textbox_Mobile_Phone"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Client_Type" ClientIDMode="Static" 
                CssClass="Big_ComboBox form-control" meta:resourcekey="dropdown_Client_Type"></asp:DropDownList></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Client_Type_Required" ErrorMessage="Please select a client type" Enabled="false" Display="Dynamic" 
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Client_Tax_Reference_Number" ClientIDMode="Static" 
                autocomplete="nope" CssClass="form-control" meta:resourcekey="textbox_Client_Tax_Reference_Number"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Main_Contact_FullName" ClientIDMode="Static" 
                autocomplete="nope" CssClass="form-control" meta:resourcekey="textbox_Main_Contact_FullName"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Main_Contact_Email_Address" ClientIDMode="Static" 
                autocomplete="nope" CssClass="form-control long-input" meta:resourcekey="textbox_Main_Contact_Email_Address"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Main_Contact_Phone_Number" ClientIDMode="Static" 
                autocomplete="nope" CssClass="form-control" meta:resourcekey="textbox_Main_Contact_Phone_Number"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Client_From_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Client_From_Date"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Client_To_Date.ClientID %>"><%= Resources.SiteCommon.Client_To_Date %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Client_To_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Client_To_Date"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_First_Contract_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_First_Contract_Date"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_First_Contract_Signed_With_Contact_Full_Name" autocomplete="nope" 
        ...
        <hr />
        <div>
            <asp:Button runat="server" ID="button_Create_Client" Text="Create Client" OnClick="button_Create_Client_Click" CssClass="btn btn-primary" meta:resourcekey="button_Create_Client" /> 
        </div>
