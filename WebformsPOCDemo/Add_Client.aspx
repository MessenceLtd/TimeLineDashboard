<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_Client.aspx.cs" Inherits="WebformsPOCDemo.Add_Client" culture="auto" uiculture="auto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="page-title my-3 text-center">
        <h2 class="display-5"><%= Resources.SiteCommon.Add_Client_Title %></h2>
        <p class="lead"><%= Resources.SiteCommon.Add_Client_SubTitle %></p>
    </div>
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Company_Name" ClientIDMode="Static" CssClass="form-control long-input" 
                autocomplete="nope"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_City" ClientIDMode="Static"
                CssClass="form-control" autocomplete="nope"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Address_Required" ErrorMessage="<%$ Resources:SiteCommon, Validator_Address_Required %>" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Address" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>
            ...
            <ContentTemplate>
                ...
                <div class="Form_Group">
                    ...
                    <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Vat_Percentage" ClientIDMode="Static" 
                        autocomplete="nope" CssClass="form-control"></asp:TextBox></div>
                </div>
            </ContentTemplate>
            <Triggers><asp:AsyncPostBackTrigger ControlID="dropdown_Country" /></Triggers>
        </asp:UpdatePanel>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Client_Type_Required" ErrorMessage="<%$ Resources:SiteCommon, Validator_Client_Type_Required %>" Enabled="false" Display="Dynamic" 
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Main_Contact_Email_Address" ClientIDMode="Static" 
                autocomplete="nope" CssClass="form-control long-input"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Main_Contact_Phone_Number" ClientIDMode="Static" 
                autocomplete="nope" CssClass="form-control"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Phone_Number_Required" ErrorMessage="<%$ Resources:SiteCommon, Validator_Main_Contact_Email_Address_Required %>" 
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Client_From_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Client_To_Date.ClientID %>"><%= Resources.SiteCommon.Client_To_Date %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Client_To_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_First_Contract_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope"></asp:TextBox></div>
        </div>
