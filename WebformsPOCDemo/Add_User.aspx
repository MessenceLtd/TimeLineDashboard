<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_User.aspx.cs" Inherits="WebformsPOCDemo.Add_User" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panel_HeaderLinks" runat="server" CssClass="header-links" meta:resourcekey="panel_HeaderLinksResource1">       
        <asp:HyperLink runat="server" Text="Add New User" CssClass="active" NavigateUrl="Add_User.aspx" meta:resourcekey="HyperLinkResource1"></asp:HyperLink>
    </asp:Panel>
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Email_Address" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Email_AddressResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Email_Address_Required" ErrorMessage="Please enter an email address" Display="Dynamic" ControlToValidate="textbox_Email_Address" CssClass="text-danger" meta:resourcekey="validator_Email_Address_RequiredResource1"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator runat="server" ID="validator_Email_Adress_Regex" ErrorMessage="Please enter a valid email address" Display="Dynamic" ControlToValidate="textbox_Email_Address" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" CssClass="text-danger" meta:resourcekey="validator_Email_Adress_RegexResource1"></asp:RegularExpressionValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Username.ClientID %>"><%= Resources.SiteCommon.Username %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Username" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_UsernameResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Username_Required" ErrorMessage="Please enter an username" Display="Dynamic" ControlToValidate="textbox_Username" CssClass="text-danger" meta:resourcekey="validator_Username_RequiredResource1"></asp:RequiredFieldValidator>
        </div>

        <asp:Panel runat="server" ID="panel_User_App_Permission_Type" CssClass="Form_Group" meta:resourcekey="panel_User_App_Permission_TypeResource1">
            <div class="Form_Label_Wrapper"><label for="<%= dropdown_App_Permission_Type.ClientID %>"><%= Resources.SiteCommon.Permission %>:</label></div>
            <div class="Form_Control"><asp:DropDownList runat="server" ID="dropdown_App_Permission_Type" ClientIDMode="Static" CssClass="Big_ComboBox form-control" meta:resourcekey="dropdown_App_Permission_TypeResource1"></asp:DropDownList></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_App_Permission_Type_Required" ErrorMessage="Please select a permission type" Display="Dynamic" 
                ControlToValidate="dropdown_App_Permission_Type" CssClass="text-danger" meta:resourcekey="validator_App_Permission_Type_RequiredResource1"></asp:RequiredFieldValidator>
        </asp:Panel>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Password.ClientID %>"><%= Resources.SiteCommon.Password %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Password" TextMode="Password" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_PasswordResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Password_Required" ErrorMessage="Please enter an password" Display="Dynamic" ControlToValidate="textbox_Password" CssClass="text-danger" meta:resourcekey="validator_Password_RequiredResource1"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator runat="server" ID="validator_Password_Strength" ErrorMessage="Password must contain english charecters. Minimum 8 length with 1 upper case, 2 lower case chars, 2 digits chars and 1 of the special char !@#$%^&*()\-_+." 
                ValidationExpression="^(?=.*[A-Z])(?=.*[!@#$%^&*()\-_+.])(?=.*[0-9].*[0-9])(?=.*[a-z].*[a-z]).{8,}$" CssClass="text-danger" ControlToValidate="textbox_Password" Display="Dynamic" meta:resourcekey="validator_Password_StrengthResource1"></asp:RegularExpressionValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Password_Repeat.ClientID %>"><%= Resources.SiteCommon.Repeat_Password %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Password_Repeat" TextMode="Password" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Password_RepeatResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Password_Repeat_Required" ErrorMessage="Please repeat the password" Display="Dynamic" ControlToValidate="textbox_Password_Repeat" CssClass="text-danger" meta:resourcekey="validator_Password_Repeat_RequiredResource1"></asp:RequiredFieldValidator>
            <asp:CompareValidator runat="server" ID="validator_Password_Repeat_Matcher" ControlToValidate="textbox_Password_Repeat" ErrorMessage="The passwords do not match"
                ControlToCompare="textbox_Password" Display="Dynamic" CssClass="text-danger" meta:resourcekey="validator_Password_Repeat_MatcherResource1"></asp:CompareValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_First_Name.ClientID %>"><%= Resources.SiteCommon.First_Name %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_First_Name" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_First_NameResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_First_Name_Required" ErrorMessage="Please enter a first name" Display="Dynamic" ControlToValidate="textbox_First_Name" CssClass="text-danger" meta:resourcekey="validator_First_Name_RequiredResource1"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Middle_Name.ClientID %>"><%= Resources.SiteCommon.Middle_Name %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Middle_Name" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Middle_NameResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Last_Name.ClientID %>"><%= Resources.SiteCommon.Last_Name %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Last_Name" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Last_NameResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Last_Name_Required" ErrorMessage="Please enter a last name" Display="Dynamic" ControlToValidate="textbox_Last_Name" CssClass="text-danger" meta:resourcekey="validator_Last_Name_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Mobile_Phone_Required" ErrorMessage="Please enter a mobile phone" Display="Dynamic" ControlToValidate="textbox_Mobile_Phone" CssClass="text-danger" meta:resourcekey="validator_Mobile_Phone_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Additional_Phone_Number" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Additional_Phone_NumberResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Birth_Date.ClientID %>"><%= Resources.SiteCommon.Birth_Date %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Birth_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Birth_DateResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Birth_Date_Required" ErrorMessage="Please enter a birth date" Display="Dynamic" ControlToValidate="textbox_Birth_Date" CssClass="text-danger" meta:resourcekey="validator_Birth_Date_RequiredResource1"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= dropdown_Gender.ClientID %>"><%= Resources.SiteCommon.Gender %>:</label></div>
            <div class="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Gender" ClientIDMode="Static" CssClass="Small_ComboBox form-control" meta:resourcekey="dropdown_GenderResource1">
                    <asp:ListItem Text="-- Select --" Value="" meta:resourcekey="ListItemResource1"></asp:ListItem>
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Gender_Required" ErrorMessage="Please enter a gender" Display="Dynamic" ControlToValidate="dropdown_Gender" CssClass="text-danger" meta:resourcekey="validator_Gender_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Heard_About_Application_From" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Heard_About_Application_FromResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Administrative_Side_Notes" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Administrative_Side_NotesResource1"></asp:TextBox></div>
        </div>
        ...
        <hr />
        <div>
            <asp:Button runat="server" ID="button_Create_User" Text="Create User" OnClick="button_Create_User_Click" CssClass="btn btn-primary" meta:resourcekey="button_Create_UserResource1" /> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button runat="server" ID="button_Fill_Up_Form_Dummy_Data_For_Test" Text="Dummy User Fillup" CssClass="btn btn-danger" CausesValidation="False" OnClick="button_Fill_Up_Form_Dummy_Data_For_Test_Click" meta:resourcekey="button_Fill_Up_Form_Dummy_Data_For_TestResource1" />
        </div>
