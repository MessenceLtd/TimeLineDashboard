...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="Form_Group">
            <div class="Form_Label_Wrapper">
                <label for="<%= dropdown_Invoice_Time_Hours.ClientID %>">Expense Time:</label></div>
            <div class="Form_Control">
        ...
        <asp:UpdatePanel runat="server" ClientIDMode="Static" ID="up_Supplier">
            <ContentTemplate>
                <asp:Panel runat="server" ID="panel_Supplier_Selection" CssClass="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= dropdown_Supplier.ClientID %>">Supplier:</label></div>
                    <div class="Form_Control">
                        <asp:DropDownList runat="server" ID="dropdown_Supplier" ClientIDMode="Static" AutoPostBack="True" OnSelectedIndexChanged="dropdown_Supplier_SelectedIndexChanged" CssClass="Big_ComboBox form-control"></asp:DropDownList></div>
        ...
        <asp:UpdatePanel runat="server" ID="up_AddExpense_AutoComplete" ClientIDMode="Static">
            <ContentTemplate>
                ...
                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= dropdown_Expense_Type.ClientID %>">Expense Type:</label></div>
                    <div class="Form_Control">
                        <asp:DropDownList runat="server" ID="dropdown_Expense_Type" ClientIDMode="Static" CssClass="form-control Big_ComboBox"></asp:DropDownList></div>
                </div>
                ...
                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_Company_Details.ClientID %>">Invoice Supplier Company:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_Company_Details" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_Tax_Reference.ClientID %>">Invoice Supplier Tax Ref:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_Tax_Reference" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= dropdown_Invoice_Supplier_Country.ClientID %>">Invoice Supplier Country:</label></div>
                    <div class="Form_Control">
                ...
                <asp:UpdatePanel runat="server" ClientIDMode="Static" ID="up_StateUpdatePanel">
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="p_Invoice_Supplier_State_Wrapper_Panel" class="Form_Group" Visible="false">
                            <div class="Form_Label_Wrapper">
                                <label for="<%= dropdown_Invoice_Supplier_State.ClientID %>">Invoice Supplier State:</label></div>
                            <div class="Form_Control">
                ...
                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_City.ClientID %>">Invoice Supplier City:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_City" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_Address_Description.ClientID %>">Invoice Address Desc:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_Address_Description" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_ZipCode.ClientID %>">Invoice Supplier ZipCode:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_ZipCode" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_WebAddress.ClientID %>">Invoice Supplier Web Address:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_WebAddress" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_Phone_Number.ClientID %>">Invoice Supplier Phone:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_Phone_Number" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>

                <div class="Form_Group">
                    <div class="Form_Label_Wrapper">
                        <label for="<%= textbox_Invoice_Supplier_Contact_FullName.ClientID %>">Supplier Contact Person:</label></div>
                    <div class="Form_Control">
                        <asp:TextBox runat="server" ID="textbox_Invoice_Supplier_Contact_FullName" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></div>
                </div>
