<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="manage_Client.aspx.cs" Inherits="WebformsPOCDemo.manage_Client" culture="auto" meta:resourcekey="Page" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Website_URL" runat="server" CssClass="Form_Control" meta:resourcekey="formControl_Wrapper_Edit_Website_URL"><asp:TextBox runat="server" ID="textbox_Website_URL" ClientIDMode="Static" CssClass="form-control long-input" meta:resourcekey="textbox_Website_URL"></asp:TextBox></asp:Panel>
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Website_URL_Required" ErrorMessage="Please enter an website" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Website_URL" CssClass="text-danger" meta:resourcekey="validator_Website_URL_Required"></asp:RequiredFieldValidator>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_City_Required" ErrorMessage="Please enter a city" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_City" CssClass="text-danger" meta:resourcekey="validator_City_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Address_Required" ErrorMessage="Please enter an address" Display="Dynamic" 
                Enabled="false" ControlToValidate="textbox_Address" CssClass="text-danger" meta:resourcekey="validator_Address_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Zipcode_Required" 
                Enabled="false" ErrorMessage="Please enter an address" Display="Dynamic" ControlToValidate="textbox_Zipcode" CssClass="text-danger" meta:resourcekey="validator_Zipcode_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Telephone" runat="server" CssClass="Form_Control" meta:resourcekey="formControl_Wrapper_Edit_Telephone"><asp:TextBox runat="server" 
                ID="textbox_Telephone" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Telephone"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Mobile_Phone_Required" ErrorMessage="Please enter a mobile phone" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Mobile_Phone" CssClass="text-danger" meta:resourcekey="validator_Mobile_Phone_Required"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= dropdown_Client_Type.ClientID %>"><%= Resources.SiteCommon.Client_Type %>:</label></div>
            <asp:Panel ID="formControl_Wrapper_Edit_Client_Type" runat="server" CssClass="Form_Control" meta:resourcekey="formControl_Wrapper_Edit_Client_Type"><asp:DropDownList 
                runat="server" ID="dropdown_Client_Type" ClientIDMode="Static" CssClass="Big_ComboBox form-control" meta:resourcekey="dropdown_Client_Type"></asp:DropDownList></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Client_Type" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_Client_Type"><asp:Label 
                runat="server" ID="label_Client_Type" meta:resourcekey="label_Client_Type"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Client_Type_Required" ErrorMessage="Please select a client type" Display="Dynamic" 
                ControlToValidate="dropdown_Client_Type" CssClass="text-danger" meta:resourcekey="validator_Client_Type_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Client_Tax_Reference_Number" runat="server" CssClass="Form_Control" meta:resourcekey="formControl_Wrapper_Edit_Client_Tax_Reference_Number"><asp:TextBox runat="server" 
                ID="textbox_Client_Tax_Reference_Number" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Client_Tax_Reference_Number"></asp:TextBox></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Client_Tax_Reference_Number" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_Client_Tax_Reference_Number"><asp:Label 
                runat="server" ID="label_Client_Tax_Reference_Number" meta:resourcekey="label_Client_Tax_Reference_Number"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Client_Tax_Reference_Number_Required" ErrorMessage="Please enter a tax reference number" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Client_Tax_Reference_Number" CssClass="text-danger" meta:resourcekey="validator_Client_Tax_Reference_Number_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Main_Contact_FullName" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_Main_Contact_FullName"><asp:Label 
                runat="server" ID="label_Main_Contact_FullName" meta:resourcekey="label_Main_Contact_FullName"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_FullName_Required" ErrorMessage="Please enter a mobile phone" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Main_Contact_FullName" CssClass="text-danger" meta:resourcekey="validator_Main_Contact_FullName_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Main_Contact_Email_Address" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_Main_Contact_Email_Address"><asp:Label 
                runat="server" ID="label_Main_Contact_Email_Address" meta:resourcekey="label_Main_Contact_Email_Address"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Email_Address_Required" ErrorMessage="Please enter a main contact email address" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Main_Contact_Email_Address" CssClass="text-danger" meta:resourcekey="validator_Main_Contact_Email_Address_Required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Phone_Number_Required" ErrorMessage="Please enter a main contact phone number" 
                Enabled="false" Display="Dynamic" ControlToValidate="textbox_Main_Contact_Phone_Number" CssClass="text-danger" meta:resourcekey="validator_Main_Contact_Phone_Number_Required"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Client_From_Date.ClientID %>"><%= Resources.SiteCommon.Client_From_Date %>:</label></div>
            <asp:Panel ID="formControl_Wrapper_Edit_Client_From_Date" runat="server" CssClass="Form_Control" meta:resourcekey="formControl_Wrapper_Edit_Client_From_Date"><asp:TextBox 
                runat="server" ID="textbox_Client_From_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Client_From_Date"></asp:TextBox></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Client_From_Date" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_Client_From_Date"><asp:Label 
                runat="server" ID="label_Client_From_Date" meta:resourcekey="label_Client_From_Date"></asp:Label></asp:Panel>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Client_To_Date.ClientID %>"><%= Resources.SiteCommon.Client_To_Date %>:</label></div>
            <asp:Panel ID="formControl_Wrapper_Edit_Client_To_Date" runat="server" CssClass="Form_Control" meta:resourcekey="formControl_Wrapper_Edit_Client_To_Date"><asp:TextBox runat="server" 
                ID="textbox_Client_To_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Client_To_Date"></asp:TextBox></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Client_To_Date" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_Client_To_Date"><asp:Label 
                runat="server" ID="label_Client_To_Date" meta:resourcekey="label_Client_To_Date"></asp:Label></asp:Panel>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_First_Contract_Date" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_First_Contract_Date"><asp:Label 
                runat="server" ID="label_First_Contract_Date" meta:resourcekey="label_First_Contract_Date"></asp:Label></asp:Panel>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_First_Contract_Signed_With_Contact_Full_Name" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_First_Contract_Signed_With_Contact_Full_Name"><asp:Label 
                runat="server" ID="label_First_Contract_Signed_With_Contact_Full_Name" meta:resourcekey="label_First_Contract_Signed_With_Contact_Full_Name"></asp:Label></asp:Panel>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_First_Contract_Signed_In_Location_Description" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel" meta:resourcekey="formControl_Wrapper_ReadOnly_First_Contract_Signed_In_Location_Description"><asp:Label 
                runat="server" ID="label_First_Contract_Signed_In_Location_Description" meta:resourcekey="label_First_Contract_Signed_In_Location_Description"></asp:Label></asp:Panel>
        </div>
        ...
        <div>
            ...
            <asp:Button runat="server" ID="button_Edit_Client_Details" 
                Text="Edit Client" OnClick="button_Edit_Client_Details_Click" CausesValidation="False" CssClass="btn btn-primary" meta:resourcekey="button_Edit_Client_Details" /> 

            <asp:Button runat="server" ID="button_Update_Client_Details" 
                Text="Save Changes" OnClick="button_Update_Client_Details_Click" CssClass="btn btn-success" meta:resourcekey="button_Update_Client_Details" /> 

            <asp:Button runat="server" ID="button_CancelEdit_Client_Details" 
                Text="Cancel Editing" OnClick="button_CancelEdit_Client_Details_Click" CausesValidation="False" OnClientClick="if (!confirm('Are you sure you want to cancel edit?')) return false;" CssClass="btn btn-danger" meta:resourcekey="button_CancelEdit_Client_Details" /> 
