<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="list_Suppliers.aspx.cs" Inherits="WebformsPOCDemo.list_Suppliers" culture="auto" meta:resourcekey="Page" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panel_HeaderLinks" runat="server" CssClass="header-links" meta:resourcekey="panel_HeaderLinks">       
        <asp:HyperLink runat="server" Text="Add New Supplier" NavigateUrl="Add_Supplier.aspx" meta:resourcekey="HyperLink"></asp:HyperLink>
    </asp:Panel>
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel_States" class="row g-2" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="form-floating">
                <asp:TextBox runat="server" ID="text_Filter_By_CityAddressZipCode" CssClass="form-control" placeholder="Filter by City / Address / Zipcode" autocomplete="nope" meta:resourcekey="text_Filter_By_CityAddressZipCode"></asp:TextBox>
    ...
    <br />
    <asp:Button runat="server" ID="button_Search_Suppliers" OnClick="button_Search_Suppliers_Click" Text="Search" CssClass="btn btn-primary" meta:resourcekey="button_Search_Suppliers" />
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel_Search_Result">
        ...
        <ContentTemplate>
            ...
            <asp:DataGrid runat="server" ID="dataGrid_Suppliers_List" AutoGenerateColumns="False" CssClass="CustomTable" Visible="False" meta:resourcekey="dataGrid_Suppliers_List">
                <Columns>
                    <asp:HyperLinkColumn DataTextField="Supplier_Id" HeaderText="ID" DataNavigateUrlField="Supplier_Id" DataNavigateUrlFormatString="manage_Supplier.aspx?id={0}" meta:resourcekey="HyperLinkColumn">
                    </asp:HyperLinkColumn>
