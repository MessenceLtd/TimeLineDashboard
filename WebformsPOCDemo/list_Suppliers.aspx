...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <br /><br />
    <asp:Label runat="server" ID="lbl_Suppliers_List_Search_Label">Enter Search Criteria:</asp:Label> 
    <asp:TextBox runat="server" ID="textbox_Search_Criteria"></asp:TextBox>
    &nbsp;
    <asp:Button runat="server" ID="button_Search_Suppliers" OnClick="button_Search_Suppliers_Click" Text="Search" />
