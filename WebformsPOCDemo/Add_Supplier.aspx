<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_Supplier.aspx.cs" Inherits="WebformsPOCDemo.Add_Supplier" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Website_URL_Required" ErrorMessage="Please enter an website" 
                Display="Dynamic" ControlToValidate="textbox_Website_URL" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Website_URL_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_City_Required" ErrorMessage="Please enter a city" 
                Display="Dynamic" ControlToValidate="textbox_City" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_City_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Address_Required" ErrorMessage="Please enter an address" 
                Display="Dynamic" ControlToValidate="textbox_Address" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Address_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Zipcode_Required" ErrorMessage="Please enter an zipcode" 
                Display="Dynamic" ControlToValidate="textbox_Zipcode" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Zipcode_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <asp:UpdatePanel runat="server" ClientIDMode="Static" ID="updatePanel_Default_Currency">
            <ContentTemplate>
                ...
                <div class="Form_Group">
                    ...
                    <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Vat_Percentage" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Vat_PercentageResource1"></asp:TextBox></div>
                </div>
            </ContentTemplate>
            <Triggers><asp:AsyncPostBackTrigger ControlID="dropdown_Country" /></Triggers>
        </asp:UpdatePanel>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Mobile_Phone_Required" ErrorMessage="Please enter a mobile phone" 
                Display="Dynamic" ControlToValidate="textbox_Mobile_Phone" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Mobile_Phone_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Supplier_Type" ClientIDMode="Static" 
                    CssClass="Big_ComboBox form-control" meta:resourcekey="dropdown_Supplier_TypeResource1"></asp:DropDownList></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Supplier_Tax_Reference_Number" ClientIDMode="Static" CssClass="form-control" meta:resourcekey="textbox_Supplier_Tax_Reference_NumberResource1"></asp:TextBox></div>
            <asp:RequiredFieldValidator runat="server" ID="validator_Supplier_Tax_Reference_Number_Required" ErrorMessage="Please enter a tax reference number" 
                Display="Dynamic" ControlToValidate="textbox_Supplier_Tax_Reference_Number" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Supplier_Tax_Reference_Number_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_FullName_Required" ErrorMessage="Please enter a mobile phone" 
                Display="Dynamic" ControlToValidate="textbox_Main_Contact_FullName" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Main_Contact_FullName_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Email_Address_Required" ErrorMessage="Please enter a main contact email address" 
                Display="Dynamic" ControlToValidate="textbox_Main_Contact_Email_Address" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Main_Contact_Email_Address_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Phone_Number_Required" ErrorMessage="Please enter a main contact phone number" 
                Display="Dynamic" ControlToValidate="textbox_Main_Contact_Phone_Number" CssClass="text-danger" Enabled="False" meta:resourcekey="validator_Main_Contact_Phone_Number_RequiredResource1"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Supplier_From_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Supplier_From_DateResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Supplier_To_Date.ClientID %>"><%= Resources.SiteCommon.Supplier_To_Date %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Supplier_To_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Supplier_To_DateResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_First_Contract_Date" 
                ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_First_Contract_DateResource1"></asp:TextBox></div>
        </div>
        ...
        <hr />
        <div>
            <asp:Button runat="server" ID="button_Create_Supplier" Text="Create Supplier" OnClick="button_Create_Supplier_Click" CssClass="btn btn-primary" meta:resourcekey="button_Create_SupplierResource1" /> 
        </div>
