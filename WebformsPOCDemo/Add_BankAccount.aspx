<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_BankAccount.aspx.cs" Inherits="WebformsPOCDemo.Add_BankAccount" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Bank_Name" ClientIDMode="Static" CssClass="form-control long-input" autocomplete="nope" meta:resourcekey="textbox_Bank_NameResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Bank_Number.ClientID %>"><%= Resources.SiteCommon.Bank_Number %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Bank_Number" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Bank_NumberResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Branch_Name.ClientID %>"><%= Resources.SiteCommon.Branch_Name %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Name" ClientIDMode="Static" CssClass="form-control long-input" autocomplete="nope" meta:resourcekey="textbox_Branch_NameResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Branch_Number.ClientID %>"><%= Resources.SiteCommon.Branch_Number %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Number" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Branch_NumberResource1"></asp:TextBox></div>
        </div>
        
        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Account_Number.ClientID %>"><%= Resources.SiteCommon.Account_Number %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Account_Number" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Account_NumberResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Account_Name.ClientID %>"><%= Resources.SiteCommon.Account_Name %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Account_Name" ClientIDMode="Static" CssClass="form-control long-input" autocomplete="nope" meta:resourcekey="textbox_Account_NameResource1"></asp:TextBox></div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_IBAN" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_IBANResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Opened_Account_DateTime" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Opened_Account_DateTimeResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Branch_Country" ClientIDMode="Static" AutoPostBack="True" 
                OnSelectedIndexChanged="dropdown_Branch_Country_SelectedIndexChanged" CssClass="Big_ComboBox form-control" meta:resourcekey="dropdown_Branch_CountryResource1"></asp:DropDownList></div>
        </div>
        ...
        <asp:UpdatePanel runat="server" ClientIDMode="Static" ID="up_StateUpdatePanel">
            <ContentTemplate>
                <asp:Panel runat="server" ID="p_State_Wrapper_Panel" class="Form_Group" Visible="False" meta:resourcekey="p_State_Wrapper_PanelResource1">
                    ...
                    <div class="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Branch_State" ClientIDMode="Static" CssClass="Big_ComboBox form-control" meta:resourcekey="dropdown_Branch_StateResource1"></asp:DropDownList></div>
                </asp:Panel>
            </ContentTemplate>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_City" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Branch_CityResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Branch_Address.ClientID %>"><%= Resources.SiteCommon.Branch_Address %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Address" ClientIDMode="Static" CssClass="form-control long-input" autocomplete="nope" meta:resourcekey="textbox_Branch_AddressResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Branch_Zipcode.ClientID %>"><%= Resources.SiteCommon.Branch_Zip_Code %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Zipcode" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Branch_ZipcodeResource1"></asp:TextBox></div>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Branch_Phone.ClientID %>"><%= Resources.SiteCommon.Branch_Phone %>:</label></div>
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Phone" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Branch_PhoneResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Main_Email_Address" ClientIDMode="Static" CssClass="form-control long-input" autocomplete="nope" meta:resourcekey="textbox_Branch_Main_Email_AddressResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Branch_Main_Contact" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Branch_Main_ContactResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Main_Contact_Phone_Number" ClientIDMode="Static" CssClass="form-control" autocomplete="nope" meta:resourcekey="textbox_Main_Contact_Phone_NumberResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Account_Active_From_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Account_Active_From_DateResource1"></asp:TextBox></div>
        </div>
        ...
        <div class="Form_Group">
            ...
            <div class="Form_Control"><asp:TextBox runat="server" ID="textbox_Account_Active_To_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope" meta:resourcekey="textbox_Account_Active_To_DateResource1"></asp:TextBox></div>
        </div>
        ...
        <div>
            <asp:Button runat="server" ID="button_Create_Client" Text="Create Bank Account" 
                OnClick="button_Create_Bank_Account_Click" CssClass="btn btn-primary" meta:resourcekey="button_Create_ClientResource1" /> 
        </div>
