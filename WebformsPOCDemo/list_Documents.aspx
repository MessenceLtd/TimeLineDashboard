<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="list_Documents.aspx.cs" Inherits="WebformsPOCDemo.Documents" culture="auto" meta:resourcekey="Page" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panel_HeaderLinks" runat="server" CssClass="header-links" meta:resourcekey="panel_HeaderLinks">       
        <asp:HyperLink runat="server" Text="Add New Document" NavigateUrl="Add_Document.aspx" meta:resourcekey="HyperLink"></asp:HyperLink>
    </asp:Panel>
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel_Search_Result">
        ...
        <ContentTemplate>
            ...
            <asp:DataGrid runat="server" ID="dataGrid_Documents_List" AutoGenerateColumns="False" CssClass="CustomTable ListTable" Visible="False" meta:resourcekey="dataGrid_Documents_List">
                <Columns>
                    <asp:HyperLinkColumn DataTextField="General_Document_Id" HeaderText="ID" 
                        DataNavigateUrlField="General_Document_Id" DataNavigateUrlFormatString="manage_Document.aspx?id={0}" meta:resourcekey="HyperLinkColumn">
                    </asp:HyperLinkColumn>
