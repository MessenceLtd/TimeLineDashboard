<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="manage_Supplier.aspx.cs" Inherits="WebformsPOCDemo.manage_Supplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Website_URL" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Country" runat="server" Visible="true" CssClass="Form_Control"><asp:DropDownList runat="server" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_City" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" ID="textbox_City" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Address" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" ID="textbox_Address" ClientIDMode="Static" CssClass="form-control long-input"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Zipcode" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" 
        ...
        <asp:UpdatePanel runat="server" ClientIDMode="Static" ID="updatePanel_Default_Currency">
            <ContentTemplate>
                <div class="Form_Group">
                    ...
                    <asp:Panel ID="formControl_Wrapper_Edit_Currency" runat="server" Visible="true" CssClass="Form_Control"><asp:DropDownList runat="server" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Telephone" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" ID="textbox_Telephone" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Mobile_Phone" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" ID="textbox_Mobile_Phone" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Supplier_Type" runat="server" Visible="true" CssClass="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Supplier_Type" ClientIDMode="Static" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Supplier_Tax_Reference_Number" runat="server" Visible="true" CssClass="Form_Control"><asp:TextBox runat="server" 
        ...
        <div>
            ...
            <asp:Button runat="server" ID="button_Edit_Supplier_Details" 
                Text="Edit Supplier" OnClick="button_Edit_Supplier_Details_Click" CausesValidation="false" CssClass="btn btn-primary" /> 

            <asp:Button runat="server" ID="button_Update_Supplier_Details" 
                Text="Save Changes" OnClick="button_Update_Supplier_Details_Click" CssClass="btn btn-success" /> 

            <asp:Button runat="server" ID="button_CancelEdit_Supplier_Details" 
                Text="Cancel Editing" OnClick="button_CancelEdit_Supplier_Details_Click" CausesValidation="false" OnSupplierClick="if (!confirm('Are you sure you want to cancel edit?')) return false;" CssClass="btn btn-danger" /> 
