<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="manage_Supplier.aspx.cs" Inherits="WebformsPOCDemo.manage_Supplier" culture="auto" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Website_URL" runat="server" CssClass="Form_Control"><asp:TextBox runat="server" 
                ID="textbox_Website_URL" ClientIDMode="Static" CssClass="form-control long-input"></asp:TextBox></asp:Panel>
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Website_URL_Required" ErrorMessage="<%$ Resources:SiteCommon, Validator_Website_URL_Required %>" Display="Dynamic" Enabled="false" 
                ControlToValidate="textbox_Website_URL" CssClass="text-danger"></asp:RequiredFieldValidator>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Country" runat="server" CssClass="Form_Control"><asp:DropDownList runat="server" 
                ID="dropdown_Country" ClientIDMode="Static" AutoPostBack="True" OnSelectedIndexChanged="dropdown_Country_SelectedIndexChanged" CssClass="Big_ComboBox form-control"></asp:DropDownList></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_City_Required" Enabled="false" 
                ErrorMessage="<%$ Resources:SiteCommon, Validator_City_Required %>" Display="Dynamic" ControlToValidate="textbox_City" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Address.ClientID %>"><%= Resources.SiteCommon.Address %>:</label></div>
            <asp:Panel ID="formControl_Wrapper_Edit_Address" runat="server" CssClass="Form_Control"><asp:TextBox 
                runat="server" ID="textbox_Address" ClientIDMode="Static" CssClass="form-control long-input"></asp:TextBox></asp:Panel>
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Address_Required" Enabled="false" 
                ErrorMessage="<%$ Resources:SiteCommon, Validator_Address_Required %>" Display="Dynamic" ControlToValidate="textbox_Address" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= textbox_Zipcode.ClientID %>"><%= Resources.SiteCommon.Zip_Code %>:</label></div>
            <asp:Panel ID="formControl_Wrapper_Edit_Zipcode" runat="server" CssClass="Form_Control"><asp:TextBox runat="server" 
                ID="textbox_Zipcode" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_Zipcode_Required" Enabled="false" 
                ErrorMessage="<%$ Resources:SiteCommon, Validator_Zipcode_Required %>" Display="Dynamic" ControlToValidate="textbox_Zipcode" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Telephone" runat="server" CssClass="Form_Control"><asp:TextBox runat="server" ID="textbox_Telephone" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Mobile_Phone" runat="server" CssClass="Form_Control"><asp:TextBox 
                runat="server" ID="textbox_Mobile_Phone" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Mobile_Phone" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Mobile_Phone"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Mobile_Phone_Required" Enabled="false" 
                ErrorMessage="<%$ Resources:SiteCommon, Validator_Mobile_Phone_Required %>" Display="Dynamic" 
                ControlToValidate="textbox_Mobile_Phone" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>

        <div class="Form_Group">
            <div class="Form_Label_Wrapper"><label for="<%= dropdown_Supplier_Type.ClientID %>"><%= Resources.SiteCommon.Supplier_Type %>:</label></div>
            <asp:Panel ID="formControl_Wrapper_Edit_Supplier_Type" runat="server" CssClass="Form_Control"><asp:DropDownList runat="server" ID="dropdown_Supplier_Type" ClientIDMode="Static" 
                    CssClass="Big_ComboBox form-control"></asp:DropDownList></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Supplier_Type" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Supplier_Type"></asp:Label></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Supplier_Tax_Reference_Number" runat="server" CssClass="Form_Control"><asp:TextBox runat="server" 
                ID="textbox_Supplier_Tax_Reference_Number" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></asp:Panel>
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Supplier_Tax_Reference_Number" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Supplier_Tax_Reference_Number"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Supplier_Tax_Reference_Number_Required" Enabled="false" ErrorMessage="<%$ Resources:SiteCommon, Validator_Supplier_Tax_Reference_Number_Required %>" 
                Display="Dynamic" ControlToValidate="textbox_Supplier_Tax_Reference_Number" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Main_Contact_FullName" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Main_Contact_FullName"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_FullName_Required" Enabled="false" ErrorMessage="<%$ Resources:SiteCommon, Validator_Main_Contact_FullName_Required %>" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Main_Contact_Email_Address" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Main_Contact_Email_Address"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Email_Address_Required" Enabled="false" ErrorMessage="<%$ Resources:SiteCommon, Validator_Main_Contact_Email_Address_Required %>" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Main_Contact_Phone_Number" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Main_Contact_Phone_Number"></asp:Label></asp:Panel>
            <asp:RequiredFieldValidator runat="server" ID="validator_Main_Contact_Phone_Number_Required" Enabled="false" ErrorMessage="<%$ Resources:SiteCommon, Validator_Main_Contact_Phone_Number_Required %>" 
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Supplier_From_Date" runat="server" CssClass="Form_Control"><asp:TextBox runat="server" 
                ID="textbox_Supplier_From_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_Edit_Supplier_To_Date" runat="server" CssClass="Form_Control"><asp:TextBox runat="server" 
                ID="textbox_Supplier_To_Date" ClientIDMode="Static" CssClass="form-control InitializeDatePicker" autocomplete="nope"></asp:TextBox></asp:Panel>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_First_Contract_Signed_With_Contact_Full_Name" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_First_Contract_Signed_With_Contact_Full_Name"></asp:Label></asp:Panel>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_First_Contract_Signed_In_Location_Description" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_First_Contract_Signed_In_Location_Description"></asp:Label></asp:Panel>
        </div>
        ...
        <div class="Form_Group">
            ...
            <asp:Panel ID="formControl_Wrapper_ReadOnly_Is_Active" runat="server" Visible="False" CssClass="Form_Control Read_Only_Panel"><asp:Label runat="server" 
                ID="label_Is_Active"></asp:Label></asp:Panel>
        </div>
        ...
        <div>
            ...
            <asp:Button runat="server" ID="button_Edit_Supplier_Details" Text="<%$ Resources:SiteCommon, Manage_Supplier_Button_Edit %>" 
                OnClick="button_Edit_Supplier_Details_Click" CausesValidation="False" CssClass="btn btn-primary" /> 

            <asp:Button runat="server" ID="button_Update_Supplier_Details" Text="<%$ Resources:SiteCommon, Manage_Supplier_Button_Save_Changes %>" 
                OnClick="button_Update_Supplier_Details_Click" CssClass="btn btn-success" /> 

            <asp:Button runat="server" ID="button_CancelEdit_Supplier_Details" Text="<%$ Resources:SiteCommon, Manage_Supplier_Button_Cancel_Editing %>" 
                OnClick="button_CancelEdit_Supplier_Details_Click" CausesValidation="False" CssClass="btn btn-danger" />
