...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-title my-3 text-center">
        <h2 class="display-5">Manage Credit Card Statement</h2>
        <p class="lead">Change and add more details for your credit card statements.</p>
    </div>
    ...
    <div>
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ErrorMessage="Please select a bank account" 
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ErrorMessage="Please select a bank account" 
        ...
        <div class="Form_Group">
            ...
            <asp:RequiredFieldValidator runat="server" ID="validator_CCStatement_DateTime_Required"
                ErrorMessage="Please enter an statement date" Display="Dynamic" ControlToValidate="textbox_CCStatement_DateTime" CssClass="text-danger"></asp:RequiredFieldValidator>
        </div>
        ...
        <asp:Panel runat="server" ID="p_Edit_Statement_File" Visible="false" class="Form_Group">
            ...
            <div class="Form_Control">
                <asp:FileUpload runat="server" ID="fileUpload_CCStatement_File" ClientIDMode="Static" 
                    CssClass="form-control" meta:resourcekey="fileUpload_CCStatement_File" />
            </div>
        </asp:Panel>
            ...
            <ContentTemplate>
                ...
                <asp:Panel runat="server" ID="panel_Add_New_CCStatement_Transaction_In_The_Begining">
                    <asp:Button runat="server" ID="button_Add_New_Bank_Account_Transactions_In_The_Begining" ClientIDMode="Static" CausesValidation="false"
                        Text="Add New Record" CssClass="btn btn-primary" OnClick="button_Add_New_Credit_Card_Transactions_Click" />
                    <br />
                </asp:Panel>
                <br />
                            ...
                            <asp:Panel runat="server" ID="panel_Bank_Account_Transaction_Id" CssClass="tr">
                                <div class="td">
                                    <asp:TextBox runat="server" ID="txt_Transaction_Date" CssClass="form-control InitializeDatePicker Transaction_Date" 
                                        autocomplete="nope" placeHolder="Transaction Date" LastEditedValue='<%# Eval("Transaction_Date", "{0:dd/MM/yyyy}" ) %>' Text='<%# Bind("Transaction_Date", "{0:dd/MM/yyyy}" ) %>'></asp:TextBox>
                                ...
                                <div class="td">
                                    <asp:TextBox runat="server" ID="txt_Business_Name" CssClass="form-control Business_Name" autocomplete="nope" 
                                        placeHolder="Business Name" LastEditedValue='<%# Eval("Business_Name") %>' Text='<%# Bind("Business_Name") %>'></asp:TextBox>
                                    <asp:Label runat="server" ID="label_Business_Name" CssClass="Business_Name" Text='<%# Bind("Business_Name" ) %>'></asp:Label>
                                </div>

                                <div class="td">
                                    <asp:TextBox runat="server" ID="txt_Transaction_Amount" CssClass="form-control Transaction_Amount" autocomplete="nope" placeHolder="Paid Amount"
                                ...
                                <div class="td">
                                    <asp:TextBox runat="server" ID="txt_Transaction_Actual_Payment_Amount" CssClass="form-control Transaction_Actual_Payment_Amount" autocomplete="nope" placeHolder="Charged Amount"
                                ...
                                <div class="td">
                                    <asp:TextBox runat="server" ID="txt_Description" CssClass="form-control Description" autocomplete="nope" 
                                        placeHolder="Description" LastEditedValue='<%# Eval("Description") %>' Text='<%# Bind("Description") %>'></asp:TextBox>
                                ...
                                <div class="td" style="text-align: center">
                                    ...
                                    <a class="Button_SaveEdit" href='<%# Eval("Credit_Card_Statement_Transaction_Id", "javascript:SaveEditCreditCardTransactionRow({0})") %>' id="SaveEditRow">
                                        <img src="/Images/save.png" width="32" height="32" alt="Edit" title="Save" /></a>
                                    <a class="Button_CancelEdit" href='<%# Eval("Credit_Card_Statement_Transaction_Id", "javascript:CancelEditCreditCardTransactionRow({0})") %>' id="CancelEditRow">
                                        <img src="/Images/cancel.png" width="32" height="32" alt="Edit" title="Cancel" /></a>
                                    <a class="Button_AddMore" href='<%# Eval("Credit_Card_Statement_Transaction_Id", "javascript:AddNewTransactionRow({0})") %>'>
                                        <img src="/Images/addmore2.png" width="32" height="32" alt="Add" title="Add" /></a>
                                    <a class="Button_Delete" href='<%# Eval("Credit_Card_Statement_Transaction_Id", "javascript:DeleteCreditCardTransactionRow({0})") %>' id="DeleteRow">
                                        <img src="/Images/delete.png" width="32" height="32" alt="Delete" title="Delete" /></a>
                                    <% } %>
                                </div>
                            </asp:Panel>
                        </ItemTemplate>
        ...
        <div>
            ...
            <asp:Button runat="server" ID="button_Edit_CreditCardStatement_Details"
            ...
            <asp:Button runat="server" ID="button_CancelEdit_CreditCardStatement_Details"
                Text="Cancel Editing" CausesValidation="False"
