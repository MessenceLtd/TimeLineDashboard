...
namespace TimeLineDashboard.DAL.Operations
{
    internal class General_Documents_Operations
    {
        ...
        internal List<General_Documents> Get_Search( string p_Search_Criteria , int p_User_Id )
        {
            ...
            bool p_Is_Active)
        {
            ...
            spDocument_Creation_DateTime.Value = p_Document_Creation_DateTime;
            ...
            spSent_By_Entity_DateTime.Value = p_Sent_By_Entity_DateTime;
